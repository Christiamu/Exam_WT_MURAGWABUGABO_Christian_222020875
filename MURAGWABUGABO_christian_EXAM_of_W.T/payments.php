...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $stmt = $connection->prepare("INSERT INTO payments(payment_id, client_id, therapist_id, session_id, amount,payment_date,payment_method) VALUES (?, ?, ?, ?, ?,?)");
    $stmt->bind_param("isssss", $payment_id, $client_id, $therapist_id, $session_id,$amount,$payment_date,$payment_method);
    ...
    $session_id = $_POST['car_model'];
    $amount = $_POST['capacity'];
    $payment_date = $_POST['capacit'];
    $payment_method = $_POST['capaci'];
